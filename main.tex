...
\include{./capitulos/cap-1-introducao}%% Comente para remover este item

%% Capítulo 1 da fundamentação teórica
\include{./capitulos/cap-2-Industria5_0}%% Comente para remover este item

%% Capítulo 2 da fundamentação teórica
%\include{./capitulos/cap-3-AvaliacaoMaturidade}%% Comente para remover este item

%% Capítulo 2 da fundamentação teórica
%\include{./capitulos/cap-4-LogicaParaconsistente}%% Comente para remover este item
